...
<head>
  <meta charset="UTF-8">
    ...
    <title>About Us | Bluefifth</title>
        ...
        <div class="w-100 mt-3">
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-st active" href="../includes/about.php">ABOUT US</a>
                    </li>
...
console.log('🔍 Navbar search functionality loaded');
  ...
  <section class="hero nav-align">
    ...
    <p>"More Than Fashion. A Shared Journey."</p>
  </section>

  <!-- About Content -->
  <section class="about-content fade-in">
    <h3>Our Story</h3>
    <p>When I started Bluefifth, I didn’t just want to make clothes—I wanted to create something that truly matters. Something that carries dignity in every stitch, and hope in every hemline.</p>
    <p>Every purchase you make connects you to the lives of people who make it possible: the farmers in the fields, the artisans at the sewing machine operators, the transporters, designers, and countless others whose livelihoods depend on this chain. Your choice puts food on their tables, books in their children’s hands, and a sense of pride in their work.</p>
    <p>At the same time, I knew this mission had to respect our planet. That’s why our production is powered by renewable energy, guided by AI precision, and committed to minimizing waste. Every Bluefifth garment is soft on your skin and gentle on the earth.</p>
    <p>To me, Bluefifth is more than a brand—it’s a movement where fashion meets responsibility. And you are at the heart of it.</p>
    <p class="signature">With gratitude,<br>
      <strong>Gowtham Chanra</strong><br>
      Founder, Bluefifth</p>
  </section>
    ...
    const content = `
        ...
        <div class="mt-4">
            ...
            <div class="alert-custom alert-success">
                <strong>💰 Earning Structurev:</strong><br>
                • 10% commission on first purchases<br>
                • 5% commission on subsequent purchases<br>
                • Claims available on 30th & 31st of every month
            </div>
