...
// Get category and products using functions.php
$category = null;
...
// Get products using enhanced function from functions.php
$productData = getProductsForCategory($categorySlug, $page, $itemsPerPage, $sort);
...
// Get SEO meta data
$seoMeta = getCategorySEOMeta($category);
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <meta name="keywords" content="<?= htmlspecialchars($seoMeta['keywords']) ?>">
    <!-- Bootstrap CSS -->
    ...
    <!-- ===== NAVBAR CSS (Add to <head> section) ===== -->
<style>
.nav-link-st.active {
    font-weight: bold;
...
<body>
    ...
    <div class="container-fluid banner-category-bg nav-align">
      <div class="row">
        <div class="d-flex flex-column justify-content-center align-items-center col-12 text-center" style=" width: 100vw;">
          <div>
            <h1 class="banner-cat-h1 d-none d-lg-block" style="font-size: 54px; color:#1E3A8A;"><?= strtoupper(htmlspecialchars($categoryName)) ?></h1>
            <h1 class="banner-cat-h1 d-lg-none d-block" style=" color:#1E3A8A;"><?= strtoupper(htmlspecialchars($categoryName)) ?></h1>
            <?php if ($categoryDescription): ?>
                <p class="lead text-dark mt-3"><?= htmlspecialchars($categoryDescription) ?></p>
            <?php endif; ?>
          </div>
        </div>
      </div>
    ...
    <div class="container mt-3">
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                ...
                <p class="text-muted mb-0"><?= $totalProducts ?> product<?= $totalProducts !== 1 ? 's' : '' ?> found</p>
            </div>
            <div class="col-md-6">
                <div class="row" >
        ...
        <?php if ($totalPages > 1): ?>
            <nav aria-label="Product pagination" class="mt-5">
                <ul class="pagination justify-content-center">
                    ...
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= buildPaginationUrl($page - 1, $categorySlug, $sort, $itemsPerPage) ?>">
                    ...
                    if ($startPage > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= buildPaginationUrl(1, $categorySlug, $sort, $itemsPerPage) ?>">1</a>
                        </li>
                        <?php if ($startPage > 2): ?>
                    ...
                    <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                        <li class="page-item <?= $i === $page ? 'active' : '' ?>">
                            <a class="page-link" href="<?= buildPaginationUrl($i, $categorySlug, $sort, $itemsPerPage) ?>"><?= $i ?></a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($endPage < $totalPages): ?>
                        ...
                        <?php endif; ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= buildPaginationUrl($totalPages, $categorySlug, $sort, $itemsPerPage) ?>"><?= $totalPages ?></a>
                        </li>
                    <?php endif; ?>
            ...
            <div class="text-center mt-3">
                <small class="text-muted">
                    Showing <?= (($page - 1) * $itemsPerPage) + 1 ?> to <?= min($page * $itemsPerPage, $totalProducts) ?> 
